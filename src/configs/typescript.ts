...
export function typescript(
  ...
  return [
    ...
    {
      files: ['**/*.d.ts'],
      name: 'wcw:typescript:dts-overrides',
      rules: {
    ...
    },
    {
      ...
      name: 'wcw:typescript:tests-overrides',
      rules: {
    ...
    {
      files: ['**/*.js', '**/*.cjs'],
      name: 'wcw:typescript:javascript-overrides',
      rules: {
